...
- **Header.php** -> Archivo que contiene la cabecera de la web.
...
- **$_POST[procesar_pago]** -> Validamos que se ha recibido la orden del botón para pagar del carrito para ir a la pantalla de pago.php.
