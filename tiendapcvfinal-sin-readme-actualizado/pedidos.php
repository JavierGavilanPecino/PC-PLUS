...
//si se accedió desde el form de pagar y el pedido no está vacío, utiliza el método
...
//Además, aquí es cuando restará el stock de la tienda, ya que, al confirmar el pago, ya tenemos la venta y podemos quitarlo
